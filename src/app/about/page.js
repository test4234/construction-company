...
export async function generateMetadata() {
  const meta = buildMeta({
    title: "About Saiganesh Constructions",
    description:
      "Saiganesh Constructions is a trusted petrol pump construction company with 15+ years of experience and 20+ successfully completed projects.",
    path: "/about",
  });
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              <strong>SaiGanesh Constructions</strong> is a specialized
